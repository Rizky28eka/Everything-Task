...
class _UpdateTaskScreenState extends State<UpdateTaskScreen> {
  ...
  void initState() {
    ...
    _subtasks.addAll(widget.taskModel.subtasks);
    for (var subtask in _subtasks) {
      _subtaskControllers.add(TextEditingController(text: subtask.title));
    }
    _selectedCategoryIds.addAll(widget.taskModel.categoryIds);
    _reminderEnabled = widget.taskModel.reminder;
    if (mounted) {
  ...
  void _addSubtask() {
    setState(() {
      final newSubtask = SubTaskModel(id: DateTime.now().millisecondsSinceEpoch.toString(), title: '');
